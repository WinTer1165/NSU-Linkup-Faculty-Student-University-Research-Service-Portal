...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errors)) {
        // Check credentials
        $stmt = $db->prepare("SELECT u.user_id, u.password, u.is_verified, u.is_banned, s.student_id, s.full_name 
                             FROM users u 
...
<head>
    ...
    <title>Student Login - NSU LinkUp</title>
    ...
    <div class="login-container">
        <div class="login-box">
            ...
            <form method="POST" action="" data-validate>
                ...
                <div class="login-footer">
                    ...
                    <p><a href="forgot-password.php?type=student">Forgot your password?</a></p>
                </div>
            </form>
        </div>
        ...
        <div class="login-banner">
            <div class="banner-content">
                ...
                <p>Connect with faculty, find research opportunities, and showcase your achievements.</p>
